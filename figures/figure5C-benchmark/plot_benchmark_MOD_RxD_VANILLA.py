...
# virtual_experiments/benchmark_dardel_VANILLA
# ------------------------------------------------------------
...
vanilla = pd.read_csv(
    "../../virtual_experiments/benchmark_dardel_VANILLA/"
    "benchmark_Dardel_VANILLA_runtime.csv"
)
...
# ------------------------------------------------------------
# Plot Vanilla, RxD, and MOD
# ------------------------------------------------------------


plot_runtime(rxd, "RxD", "black")
plot_runtime(mod, "MOD", "red")
plot_runtime(vanilla, "No modulation", "grey")
...
fig.savefig(
    "rxd_mod_ref_runtime_scaling.pdf",
    bbox_inches="tight",
)

fig.savefig(
    "rxd_mod_ref_runtime_scaling.png",
    dpi=300,
    bbox_inches="tight",
)
