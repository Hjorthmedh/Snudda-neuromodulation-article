...
print("snudda_plot_rxd  networks/single_dspn/ networks/single_dspn/simulation/output.hdf5 --neuron_id 0 --compartment_id 5")
print("snudda_plot_rxd  networks/single_dspn/ networks/single_dspn/simulation/output.hdf5 --neuron_id 1 --compartment_id 5")
