...
if os.getenv("NETWORK_PATH"):
    ...
    network_path = os.path.join(network_base_path, "striatum_with_dopamine_dspn_MOD")
...
snd_init.network_data["regions"]["Cube"]["neurons"]["dSPN"]["reaction_diffusion"] = "reaction_diffusion_DA_only.json"
snd_init.network_data["regions"]["Cube"]["neurons"]["dSPN"]["modulation"] = "modulation_parameters_mod.json"
snd_init.network_data["regions"]["Cube"]["neurons"]["dSPN"]["modulation_key"] = "abc"

snd_init.network_data["regions"]["Cube"]["neurons"]["dSPN"]["extra_mechanisms"] = {"soma": ["Nair_2016_optimized_ptr"], "basal": ["Nair_2016_optimized_ptr"]}
