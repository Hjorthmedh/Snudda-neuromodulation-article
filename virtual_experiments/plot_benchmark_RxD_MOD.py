...
rxd = pd.read_csv(
    "benchmark_dardel_RxD/benchmark_dardel_rxd_runtime.csv",
    skipinitialspace=True,
)

mod = pd.read_csv(
    "benchmark_dardel_MOD/benchmark_dardel_MOD_runtime.csv",
    skipinitialspace=True,
)
...
print(f"Writing rxd_mod_runtime_saling.png (.pdf)")
fig.savefig("rxd_mod_runtime_scaling.pdf")
fig.savefig("rxd_mod_runtime_scaling.png", dpi=300)
