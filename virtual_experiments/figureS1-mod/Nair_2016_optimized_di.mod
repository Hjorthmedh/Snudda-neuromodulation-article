TITLE Nair_2016_optimized_di
COMMENT
	automatically generated from an SBtab file
	date: Tue Jun 23 12:20:31 2026
	derivimplicit variant: identical cascade to Nair_2016_optimized,
	but DERIVATIVE block is integrated with METHOD derivimplicit
	instead of euler. SUFFIX renamed so both can coexist in one build.
ENDCOMMENT
NEURON {
	SUFFIX Nair_2016_optimized_di : OR perhaps POINT_PROCESS ?
	RANGE O1 : output
...
BREAKPOINT {
	SOLVE ode METHOD derivimplicit
